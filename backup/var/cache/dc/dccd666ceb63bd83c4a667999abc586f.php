...
/* @theme/snippets/script-tags/head.twig */
class __TwigTemplate_ad7462e0bbd891a67d2b6ecfc0a96abb extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, true, false, 1), "custom", [], "any", false, true, false, 1), "head", [], "any", true, true, false, 1) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, false, false, 1), "custom", [], "any", false, false, false, 1), "head", [], "any", false, false, false, 1))) {
            // line 2
...
";
        // line 15
        if ((((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, true, false, 15), "ga", [], "any", false, true, false, 15), "is_enabled", [], "any", true, true, false, 15) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, false, false, 15), "ga", [], "any", false, false, false, 15), "is_enabled", [], "any", false, false, false, 15)) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, true, false, 15), "ga", [], "any", false, true, false, 15), "measurement_id", [], "any", true, true, false, 15)) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, false, false, 15), "ga", [], "any", false, false, false, 15), "measurement_id", [], "any", false, false, false, 15))) {
            // line 16
...
";
        // line 27
        if ((((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, true, false, 27), "intercom", [], "any", false, true, false, 27), "is_enabled", [], "any", true, true, false, 27) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, false, false, 27), "intercom", [], "any", false, false, false, 27), "is_enabled", [], "any", false, false, false, 27)) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, true, false, 27), "intercom", [], "any", false, true, false, 27), "app_id", [], "any", true, true, false, 27)) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["option"] ?? null), "script_tags", [], "any", false, false, false, 27), "intercom", [], "any", false, false, false, 27), "app_id", [], "any", false, false, false, 27))) {
            // line 28
            yield "<script>
...
";
    ...
    {
        return "@theme/snippets/script-tags/head.twig";
    }
    ...
    {
        return array (  193 => 65,  186 => 60,  183 => 59,  177 => 57,  175 => 56,  171 => 54,  162 => 51,  158 => 50,  154 => 49,  151 => 48,  147 => 47,  143 => 45,  137 => 43,  135 => 42,  131 => 41,  127 => 40,  123 => 39,  118 => 37,  114 => 36,  110 => 35,  103 => 34,  101 => 33,  96 => 31,  91 => 28,  89 => 27,  86 => 26,  80 => 23,  71 => 17,  68 => 16,  66 => 15,  63 => 14,  57 => 11,  50 => 6,  48 => 5,  45 => 4,  40 => 2,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@theme/snippets/script-tags/head.twig", "/home/u489518759/domains/renvon.com/public_html/content/plugins/heyaikeedo/default/snippets/script-tags/head.twig");
    }
}
